...
contract AdminContract is IAdminContract, OwnableUpgradeable {
    ...
    mapping(address => IDysonRewardPool) public dysonRewardPool;
    ...
    function addNewCollateral(
        ...
        collateralParams[_collateral] = CollateralParams({
            ...
            active: false,
            isRewardPoolType: _isRewardPoolType,
            mcr: MCR_DEFAULT,
            ccr: CCR_DEFAULT,
    ...
    function getIsRewardPoolType(
        address _collateral
    ) external view override exists(_collateral) returns (bool) {
        return collateralParams[_collateral].isRewardPoolType;
    }
    ...
    function setDysonRewardPool(
        address _collateral,
        address _rewardPool
    ) external onlyOwner {
        dysonRewardPool[_collateral] = IDysonRewardPool(_rewardPool);

        emit DysonRewardPoolChanged(_collateral, _rewardPool);
    }
    ...
    function setRewardPoolType(
        address _collateral,
        bool _isRewardPoolType
    ) public onlyOwner {
        CollateralParams storage collParams = collateralParams[_collateral];
        collParams.isRewardPoolType = _isRewardPoolType;
    }
