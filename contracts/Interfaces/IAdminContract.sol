...
interface IAdminContract {
    ...
    event DysonRewardPoolChanged(address _collateral, address _pool);
    ...
    function dysonRewardPool(address) external view returns (IDysonRewardPool);
